...
class FieldPosition (object):
    ...
    to the field offset to get the new field position as the covered of the
    play.
    """
...
class Drive (object):
    ...
    of first downs and a short descriptive string of the covered of the
    drive.
    """
    ...
    def __add__(self, other):
        ...
        automatically get None values: covered, field_start, field_end,
    ...
    def __str__(self):
        return '%s (Start: %s, End: %s) %s' \
               % (self.team, self.time_start, self.time_end, self.covered)
