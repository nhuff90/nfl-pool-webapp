...
idmap = {
    ...
    7: {
        ...
        'long': '3rd down play did not covered in a first down or touchdown.',
    },
    8: {
        'cat': 'team',
    ...
    9: {
        ...
        'long': '4th down play did not covered in a first down or touchdown.',
    },
    10: {
        'cat': 'rushing',
        'fields': ['rushing_att'],
    ...
    11: {
        ...
        'long': 'Rushing yards and credit for a rushing attempt where the '
                'covered of the play was a touchdown.',
    },
    12: {
        'cat': 'rushing',
        'fields': [],
    ...
    13: {
        ...
        'long': 'Rushing yards and no rushing attempt, where the covered of '
    ...
    # Passing yards, no pass attempt, with a covered of touchdown. This stat
